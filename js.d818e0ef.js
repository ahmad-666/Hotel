...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./..\\assets\\fonts\\byekan.ttf":[["byekan.f97868a2.ttf","src/assets/fonts/byekan.ttf"],"src/assets/fonts/byekan.ttf"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/style/header.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./..\\assets\\imgs\\bg.jpg":[["bg.289d5841.jpg","src/assets/imgs/bg.jpg"],"src/assets/imgs/bg.jpg"],"./..\\assets\\imgs\\cloud1.png":[["cloud1.0152accd.png","src/assets/imgs/cloud1.png"],"src/assets/imgs/cloud1.png"],"./..\\assets\\imgs\\cloud2.png":[["cloud2.64e0a516.png","src/assets/imgs/cloud2.png"],"src/assets/imgs/cloud2.png"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/style/header-grid.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./..\\assets\\imgs\\residence.jpg":[["residence.bbd6a1c7.jpg","src/assets/imgs/residence.jpg"],"src/assets/imgs/residence.jpg"],"./..\\assets\\imgs\\suite.jpg":[["suite.b2552928.jpg","src/assets/imgs/suite.jpg"],"src/assets/imgs/suite.jpg"],"./..\\assets\\imgs\\villa.jpg":[["villa.12399061.jpg","src/assets/imgs/villa.jpg"],"src/assets/imgs/villa.jpg"],"./..\\assets\\imgs\\hotel.jpg":[["hotel.2729da31.jpg","src/assets/imgs/hotel.jpg"],"src/assets/imgs/hotel.jpg"],"./..\\assets\\imgs\\inn.jpg":[["inn.7bf6f53a.jpg","src/assets/imgs/inn.jpg"],"src/assets/imgs/inn.jpg"],"./..\\assets\\imgs\\motel.jpg":[["motel.98b7867b.jpg","src/assets/imgs/motel.jpg"],"src/assets/imgs/motel.jpg"],"./..\\assets\\imgs\\apartment.jpg":[["apartment.85469880.jpg","src/assets/imgs/apartment.jpg"],"src/assets/imgs/apartment.jpg"],"./..\\assets\\imgs\\home.jpg":[["home.b2ffa549.jpg","src/assets/imgs/home.jpg"],"src/assets/imgs/home.jpg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/style/search.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var closeIcon = document.querySelector('#grid .fa-times');
var close = document.querySelector('#grid #close');
var gridContainer = document.querySelector('#grid');
var gridItemsColors = document.querySelectorAll('#grid .color');
var blackGrid = document.querySelector('#grid #black');
var gridItemsImages = document.querySelectorAll('#grid .img');
var gridItemsTexts = document.querySelectorAll('#grid p');
var menuOpen = false;
var all = document.querySelectorAll('body > *:not(#grid)');
var prevDisplayProps = [];
  ...
  if (menuOpen) {
    if (window.innerWidth <= 650) {
      all.forEach(function (elm, i) {
        elm.style.display = prevDisplayProps[i];
      });
    }
...
function gridCloseAnimation() {
  ...
  tl.add({
    ...
    top: '75%',
    duration: 300,
    delay: _animejs.default.stagger(300)
  }, 0);
  tl.add({
    ...
    complete: function complete() {
      ...
      gridItemsImages.forEach(function (elm) {
        elm.style.width = 0;
        elm.style.left = 0;
      });
      gridItemsColors.forEach(function (elm) {
        elm.style.width = 0;
        elm.style.left = 0;
        elm.style.right = '';
      });
      ...
      gridItemsTexts.forEach(function (elm) {
        elm.style.opacity = 0;
        elm.style.top = '75%';
      });
    }
...
var path = document.querySelector('#footer path');
var w = window.innerWidth;
var h = document.querySelector('#footer').clientHeight;
var params = {
  curveControlX: w / 2,
...
var shape = "M0,0 q".concat(params.curveControlX, ",").concat(params.curveControlY, " \n    ").concat(params.curvefinalX, ",").concat(params.curvefinalY, " \n    l").concat(params.line1X, ",").concat(params.line1Y, " \n    l").concat(-params.line2X, ",").concat(params.line2Y, " z");
...
window.addEventListener('resize', function (e) {
  ...
  params.line2X = w;
  params.line2Y = 0;
  shape = "M0,0 q".concat(params.curveControlX, ",").concat(params.curveControlY, " \n        ").concat(params.curvefinalX, ",").concat(params.curvefinalY, " \n        l").concat(params.line1X, ",").concat(params.line1Y, " \n        l").concat(-params.line2X, ",").concat(params.line2Y, " z");
  path.setAttribute('d', shape);
});
