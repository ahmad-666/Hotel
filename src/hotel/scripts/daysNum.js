...
function setDaysNum(){
    ...
    else if(calenderInDate.isAfter(calenderOutDate)) daysNum = '' ; //if calenderIn is bigger   
    else if(calenderIn.compareTo.hiddenForm.value == '') daysNum = '' ; //if calenderIn is smaller but we dont have value for calenderOut   
