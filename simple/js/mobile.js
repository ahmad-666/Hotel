...
let mycurrFilters = document.querySelector('#curr-filters') ;
...
function scrollHandler(e){
    if(mycurrFilters.getBoundingClientRect().top < window.innerHeight && footer.getBoundingClientRect().top > window.innerHeight) betweenCurrAndFooter = true ;
